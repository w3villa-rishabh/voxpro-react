      ...
      <div className="font-12 position-relative p-5">
        ...
        <div
          ...
          <div className="text-center w-100">
            ...
            <p>Press enter</p>
            <div className="pt-5 font-weight-bold font-size-xs">
              <h6 className="font-weight-bold">DISCLAIMER</h6>
              <p>
                Voxpro assumes no responsibility for the result of this test.
                This result given is in accordance with HMRC starts by.
              </p>
              <span className="font-italic">Warning</span>
              <br></br>
            ...
            <Grid item xs={12}>
              ...
              <div className="d-flex">
                ...
                <Radio
                  ...
                  aria-label="B"
                />
                <span className="mt-3 mr-1">No</span>
              </div>
              <Button
                variant="contained"
                onClick={() => {
                ...
                <ul>
                  <li>
                    <div className="question-box">
                      <span className="border-1 mr-2 mt-3 p-1">A</span>
                      <span className="mt-3">Yes</span>
                      <Radio
                        checked={policyObj.limitedCompany === 'a'}
                        onChange={() => {
                  ...
                  <li>
                    <div className="question-box mt-2">
                      <span className="border-1 mr-2 mt-3 p-1">B</span>
                      <span className="mt-3 mr-1">No</span>
                      <Radio
                        checked={policyObj.limitedCompany === 'b'}
                        onChange={() => {
        ...
        <div
          ...
          <Grid container spacing={1} className="pt-3">
            <Grid item xs={12}>
              <h4>
                Does your organisation have the right to move the worker from
                the task they originally agreed to do?
              </h4>
              <div className="text-f">
                <span>
                  A worker taken on for general tasks, rather than one specific
                  task, might be moved as and when priorities change. The client
                  may not need the worker’s permission to move them.
                </span>
                <br />
        ...
        <div
          ...
          <Grid container spacing={1} className="pt-3">
            <Grid item xs={12}>
              <h4>
                Does your organisation have the right to decide how the work is
                done?
              </h4>
              <div className="text-f">
                <span>
        ...
        <div
          ...
          <Grid container spacing={1} className="pt-3">
            <Grid item xs={12}>
              <h4>
                Does your organisation have the right to decide where the worker
                does the work?
              </h4>
        ...
        <div
          ...
          <Grid container spacing={1} className="pt-3">
            <Grid item xs={12}>
              <h4>
                Will the worker have to buy equipment before your organisation
                pays them?
              </h4>
              <div className="text-f">
                <span>
                  This can include heavy machinery or high-cost specialist
                  equipment used for this work. This does not include laptops,
                  tablets and phones.
                </span>
            ...
            <Grid item xs={12}>
              ...
              <div className="text-f">
                <span>
                  ...
                  running costs for this work. This does not include commuting
                  or personal vehicle costs.
                </span>
              </div>
        ...
        <div
          ...
          <Grid container spacing={1} className="pt-3">
            <Grid item xs={12}>
              <h4>
                Will the worker have to buy materials before your organisation
                pays them?
              </h4>
              <div className="text-f">
                <span>
                  This can include items that form a lasting part of the work,
                  or are left behind when the worker leaves. This does not
