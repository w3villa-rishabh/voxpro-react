...
//Hide Jobs
const HideJobComponent = lazy(() =>
  import('./components/candidate_jobs/hidden_jobs')
);
...
// candidate job
const JobComponent = lazy(() => import('./components/candidate_jobs/jobs'));
...
const AddJobsJobs = lazy(() => import('./components/agency_jobs/add-jobs'));
            ...
            <Route
              ...
              <LeftSidebar>
                <Switch>
                  ...
                  <Route path="/hide-jobs" component={HideJobComponent} />
                  <Route path="/search-job" component={JobComponent} />
                  <Route path="/jobs" component={JobSearchComponent} />
                  <Route path="/view-job" component={ViewJob} />
                  <Route path="/jobs-live" component={AgencyJobsLive} />
                  <Route path="/add-job" component={AddJobsJobs} />
